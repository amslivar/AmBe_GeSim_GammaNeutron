...
gesimMaterial::gesimMaterial ()
{
  ...
  fMaterialMessenger = new gesimMaterialMessenger(this);
}
////////////////////////////////////////////////////////////////////////////////
//
gesimMaterial::~gesimMaterial ()
...
////////////////////////////////////////////////////////////////////////////////
//
void gesimMaterial::AddMaterial (G4Material * aMaterial){
  fMaterial.push_back(aMaterial);
  G4cout <<" fMaterial:" << aMaterial->GetName() << " added! " <<G4endl;
...
void gesimMaterial::AddMaterial (G4String name, G4String formula,
...
////////////////////////////////////////////////////////////////////////////////
//
void gesimMaterial::DeleteMaterial (G4int j)
{
  size_t i(j-1);
  if (i > fMaterial.size()) {
...
////////////////////////////////////////////////////////////////////////////////
//
void gesimMaterial::DeleteMaterial (G4String )
{
  G4cerr <<"It seems there is no mechanism in G4 for deleting a material yet!"
         <<G4endl;
  G4cerr <<"--> Command rejected." <<G4endl;
...
////////////////////////////////////////////////////////////////////////////////
//
G4int gesimMaterial::GetMaterialIndex (G4String name)
{
  size_t i ;
  for (i = 0; i < fMaterial.size(); i++) {
...
////////////////////////////////////////////////////////////////////////////////
//
void gesimMaterial::ListMaterial ()
{
